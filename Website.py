...
def geocode_address(address):
    try:
        ...
        headers = {"User-Agent": "CompanyLookupTool/1.0"}
...
def lookup():
    ...
    addr = data.get("registered_office_address") or data.get("address") or {}
    address_parts = [
    ...
    return jsonify({
        "name": data.get("company_name") or data.get("title", "Unknown"),
